...
引用：`doc_consolidation/progress/dc-t1.md:32-36`、`doc_consolidation/progress/dc-t2.md:285-288`
...
引用：`doc_consolidation/progress/dc-t1.md:13-17`
...
引用：`doc_consolidation/progress/dc-t1.md:111-118`、`doc_consolidation/TEAM_CONFIG.md:82-84`
...
引用：`doc_consolidation/progress/dc-t1.md:21-24`、`TEAM_CONFIG.md:21-26,132-149`
...
引用：`doc_consolidation/progress/dc-t2.md:10-21`
...
引用：`doc_consolidation/progress/dc-t2.md:10-21,231-248`、`SESSION_HANDOFF.md:3-4,347`
...
引用：`doc_consolidation/progress/dc-t1.md:222`、`doc_consolidation/progress/dc-t2.md:285-287`、`PROJECT_SUMMARY.md:198`
...
引用：`doc_consolidation/progress/dc-t1.md:44-47`
...
引用：`doc_consolidation/progress/dc-t2.md:34-42`
...
引用：`doc_consolidation/progress/dc-t1.md:48-55`、`doc_consolidation/progress/dc-t2.md:39-48`
...
引用：`doc_consolidation/progress/dc-t1.md:48-55`、`doc_consolidation/progress/dc-t2.md:44-48`
...
引用：`doc_consolidation/progress/dc-t2.md:50-54`
...
引用：`doc_consolidation/progress/dc-t2.md:62-63`
...
引用：`doc_consolidation/progress/dc-t2.md:67-71`、`doc_consolidation/progress/dc-t1.md:66`
...
引用：`FINAL_REPORT.md:84`、`doc_consolidation/progress/dc-t1.md:60-64`
...
引用：`doc_consolidation/progress/dc-t1.md:64`、`doc_consolidation/progress/dc-t2.md:81-82`
...
引用：`doc_consolidation/progress/dc-t2.md:74-87`、`doc_consolidation/progress/dc-t1.md:66-68`、`FINAL_REPORT.md:91-95`
...
引用：`doc_consolidation/progress/dc-t2.md:94-102`、`doc_consolidation/progress/dc-t1.md:72-75`
...
引用：`doc_consolidation/progress/dc-t2.md:104-108`
...
引用：`PROJECT_SUMMARY.md:198,224`、`doc_consolidation/progress/dc-t1.md:73-75`
...
引用：`doc_consolidation/progress/dc-t2.md:114-128`、`PROJECT_SUMMARY.md:117-132`
...
引用：`doc_consolidation/progress/dc-t2.md:131-133,236-237,243`
...
引用：`doc_consolidation/progress/dc-t2.md:131-133`、`doc_consolidation/progress/dc-t1.md:77-80`、`FINAL_REPORT.md:28,46,125`
...
引用：`doc_consolidation/progress/dc-t2.md:140-144`、`doc_consolidation/progress/dc-t1.md:88-90`
...
引用：`doc_consolidation/progress/dc-t2.md:147-160`、`doc_consolidation/progress/dc-t1.md:94-96`
...
引用：`doc_consolidation/progress/dc-t2.md:147-160,259-260`
...
引用：`doc_consolidation/progress/dc-t2.md:166-173`、`doc_consolidation/progress/dc-t1.md:99-104`、`PROJECT_SUMMARY.md:252`
...
引用：`doc_consolidation/progress/dc-t1.md:108-118`
...
引用：`doc_consolidation/progress/dc-t1.md:124-150`
...
引用：`doc_consolidation/progress/dc-t1.md:160-184`、`doc_consolidation/progress/dc-t2.md:208-215`、`FINAL_REPORT.md:163-170`、`SESSION_HANDOFF.md:347`
...
引用：`doc_consolidation/progress/dc-t2.md:231-248`

---

## §12 后续可选优化

> 仅列出，不展开 dead end。完整清单见 `FINAL_REPORT.md` §4 / `doc_consolidation/progress/dc-t1.md` §8。
...
- §2 总体流程：`SESSION_HANDOFF.md:3-4,347`、`doc_consolidation/progress/dc-t2.md:10-21`
...
- §8 dispatch 对比：见 `doc_consolidation/progress/dc-t1.md:108-118` 整合表
- §9 三仓改动：见 `doc_consolidation/progress/dc-t1.md:124-150` 整合表
...
- §11 时间线：`doc_consolidation/progress/dc-t2.md:231-248`
