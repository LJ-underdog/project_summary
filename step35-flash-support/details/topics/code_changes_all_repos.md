...
> 该 fix **仅 op-isolate(inter=160) 验证过、未在 TP e2e 验证**（之前 e2e 误用 EP），**stage1 镜像 bug 未修**。完整状态见 `NOPAD_TP_HANDOFF.md`（W8_resume 工作文件，非本仓）；三-bug 辨析见 [`../TP8_THREE_BUGS.md`](../TP8_THREE_BUGS.md)。
