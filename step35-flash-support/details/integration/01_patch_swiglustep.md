...
> 此文档为 **step35-flash-support 系列 patch 文档之一**, 完整索引见 [README.md](./README.md)。兄弟 doc: [02_patch_swa_perlayer.md](./02_patch_swa_perlayer.md) (ATOM SWA per-layer KV) | 共同教训: [03_lessons.md](./03_lessons.md)。
>
...
- **Key progress** (本机源 wave 路径 `project_step35_vllm_repro/`, 未随 doc 一起 push, 仅作 wave 期间 audit trail 引用):
