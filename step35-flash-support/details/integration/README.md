...
| Doc | 内容 | 主要受众 |
|---|---|---|
| **[README.md](./README.md)** (本文档) | 任务背景 / 2 patch 一览 / 共同 caveat / 文档地图 | 接手人快速 entry |
...
- **本 doc 集 Phase 1 调研**: 本机源 wave 路径 `project_step35_vllm_repro/progress/teammate-DOC1-A.md` (Patch A) + `project_step35_vllm_repro/progress/teammate-DOC1-B.md` (Patch B) — 未随 doc 一起 push, 仅作 wave 期间 audit trail 引用
