...
> 此文档为 **step35-flash-support 系列 patch 文档之一**, 完整索引见 [README.md](./README.md)。兄弟 doc: [01_patch_swiglustep.md](./01_patch_swiglustep.md) (vllm SwigluStep enum 加白) | 共同教训: [03_lessons.md](./03_lessons.md)。
...
| Key progress (timeline 实证源) | 本机源 wave 路径 `project_step35_vllm_repro/progress/teammate-{48,50,51,52,55,58,63,65,71}.md` (未随 doc 一起 push, 仅作 wave 期间 audit trail 引用) |
