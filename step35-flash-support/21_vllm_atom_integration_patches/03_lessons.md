...
> 此文档为 **step35-flash-support 系列 patch 文档之一**, 完整索引见 [00_overview.md](./00_overview.md)。兄弟 doc: [01_patch_swiglustep.md](./01_patch_swiglustep.md) | [02_patch_swa_perlayer.md](./02_patch_swa_perlayer.md)。
>
...
3. **00_overview.md 集中重复一次共同 caveat** (本 doc 集已做, §"共同 caveat" 节)
